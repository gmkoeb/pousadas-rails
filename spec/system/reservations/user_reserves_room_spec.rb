...
describe 'Usuário reserva um quarto' do
  ...
  it 'e vê preço total' do
    ...
    expect(page).to have_content 'Valor total da reserva: R$35000'
  ...
  it 'e quarto está disponível' do
    ...
    expect(page).to have_content "Data de Entrada: #{I18n.localize(Date.tomorrow)}" 
    expect(page).to have_content "Data de Saída: #{I18n.localize(Date.tomorrow + 7)}" 
    ...
    expect(page).to have_content 'Valor total da reserva: R$35000 (7 dias)' 
    expect(page).to have_button 'Efetuar Reserva' 
  end
