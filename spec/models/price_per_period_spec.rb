  ...
  describe '#valid?' do
    ...
    context 'validação de datas' do
      it 'datas sobrepostas' do
        ...
        price_2 = room.price_per_periods.new(special_price: 12345, starts_at: Date.today + 1, ends_at: Date.tomorrow + 2)
        # Act
        price_2.valid?
    ...
    context 'presence' do
      ...
      it 'data de ínicio em branco' do
        ...
        room = inn.rooms.new(name: 'Quarto Master', description: 'Melhor quarto da pousada.', area: 50, 
                               price: 5000, maximum_guests: 5, has_bathroom: true, has_balcony: true, accessible: true)
        price = room.price_per_periods.new(special_price: 1, ends_at: Date.tomorrow)
        # Act
        price.valid?
      ...
      it 'data de término em branco' do
        ...
        room = inn.rooms.new(name: 'Quarto Master', description: 'Melhor quarto da pousada.', area: 50, 
                               price: 5000, maximum_guests: 5, has_bathroom: true, has_balcony: true, accessible: true)
        price = room.price_per_periods.new(special_price: 1, starts_at: Date.today)
        # Act
        price.valid?
